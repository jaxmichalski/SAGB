...
def pitcherDeception(classData):
	...
	####################
	# sets all pis equal, to eliminate the influence of priors
	# this will theoretically make the score more about the pitch itself, not the pitch mix
	num_pitch_types = len(pis.keys())
	for key in pis.keys():
		pis[key] = 1. / num_pitch_types
